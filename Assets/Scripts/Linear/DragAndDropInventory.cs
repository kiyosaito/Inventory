...
//    private Rect clampToScreen(Rect r)//cl
//    {
...
//    {
//        droppedItem = draggedItem.ObjectMesh;
...
//        GUI.Box(new Rect(0, scr.y * 4, scr.x * 5.5f, scr.y * 0.5f), "Gold Display");
//        showToolTip = false;
